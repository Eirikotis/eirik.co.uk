...
- Separate demonstrated capability from preferred environment. Eirik has directly demonstrated both autonomy and collaboration: through independently built and operated systems, owned client workstreams, founder-facing work, cross-functional stakeholder delivery and coordination of specialist engineers. Never describe autonomy or collaboration as merely interests or as undemonstrated. A narrower or more procedural role may be a less natural long-term fit, but that is not the same as lacking those capabilities or being unable to work within structured processes.
